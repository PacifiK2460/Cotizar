...
def imprimir_cot(cop,cam,alto,ancho,largo,t_precio):
    ...
    def cot():
        ...
        def camioneta_sin():
                ...
                abrir_esto.set_titulo(doc_tittle)
    ...
    def task(root):
        ...
        txt.pack()
        pb_hD = Progressbar(root, orient='horizontal', mode='indeterminate',length=270)
        pb_hD.pack(padx=5,pady=5)
        pb_hD.start(50)
        root.mainloop()
    ...
    def Main():
        ...
        root.geometry("300x70") #Tam. original: 245x180
        root.resizable(0,0)
