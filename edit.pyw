...
try:
    ...
    messagebox.showerror("Error","Puede que el archivo en donde se almacenaban los datos haya sido eliminado o movido.")
    cont = False
    messagebox.showinfo("Aviso","Por favor vuelva a poner el archivo ''datos.csv'' en donde estaba y reinicie el programa")
